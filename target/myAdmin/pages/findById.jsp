                    ...
                    $.ajax({
                        ...
                        success:function (user) {
                            if(user.id==null){
                                ...
                                //alert(user);
                                var data='<td>'+user.id+'</td>';
                                data+='<td>'+user.username+'</td>';
                                if(user.age!=null){
                                    data+='<td>'+user.age+'</td>';
                                }
                                data+='<td>无</td>';
                                data+='<td>'+user.birthday+'</td>';
                                data+='<td>'+user.sex+'</td>';
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="table row-top">
                    <form <%--action="../user/findById"--%> class="row-left form-inline">
                        <div class="form-group">
                            <label for="exampleInputName2">ID：</label>
                            <input id="id" <%--name="id"--%> type="text" class="form-control" id="exampleInputName2" placeholder="请输入ID">
                        </div>
                        <button type="button" class="btn-primary btn-sm" id="select">ajax查询</button>
